...
$cres = mysqli_query($conn,$clients);
            ...
            <div class="mdc-list-item mdc-drawer-item">
              ...
              <div class="mdc-expansion-panel" id="ui-sub-menu">
                <nav class="mdc-list mdc-drawer-submenu">
                  ...
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="../forms/viewfundis.php">
                      View Fundis
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="../forms/viewclients.php">
                      View Clients
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
              $i=1;
              while($row=mysqli_fetch_assoc($bk)){?>
              <tr style="background-color:white; font-size: 14px;">
          ...
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                <span class="text-center text-sm-left d-block d-sm-inline-block tx-14">Copyright © Fundis </a>2020</span>
              </div>
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop d-flex justify-content-end">
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center tx-14"> material admin </a> dashboards from Fundis</span>
              </div>
            </div>
          </div>
        </footer>
