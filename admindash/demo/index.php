...
//count unaattended services
$unatt = "SELECT count(*) FROM bookings WHERE status = 1";
$ua = mysqli_query($conn,$unatt);

//count attended to clients
$att = "SELECT count(*) FROM bookings WHERE status = 0";
$at = mysqli_query($conn,$att);
...
while($row = mysqli_fetch_array($ua)){
  $unattended = $row['count(*)'];
}
            ...
            <div class="mdc-list-item mdc-drawer-item">
              ...
              <div class="mdc-expansion-panel" id="ui-sub-menu">
                <nav class="mdc-list mdc-drawer-submenu">
                  ...
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="../demo/pages/forms/viewfundis.php">
                      View Fundis
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="../demo/pages/forms/viewclients.php">
                      View Clients
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card info-card info-card--success">
                  <div class="card-inner">
                    <h5 class="card-title">Fundis</h5>
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom"><?php echo $regcounter ?></h5>
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card info-card info-card--danger">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom"><?php echo $clientcount ?></h5>
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card info-card info-card--info">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom">$<?php echo $avg?></h5>
                    <p class="tx-12 text-muted">87% target reached</p>
                    <div class="card-icon-wrapper">
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card bg-success text-white">
                  <div class="d-flex justify-content-between">
                    <h3 class="font-weight-normal">Attended to:</h3>
                  ...
                  <div class="mdc-layout-grid__inner align-items-center">
                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-4-desktop mdc-layout-grid__cell--span-3-tablet mdc-layout-grid__cell--span-2-phone">
                      <div>
                        ...
                        <h1 class="font-weight-normal mt-3 mb-0"><?php echo $attended ?></h1>
                      </div>
                    </div>
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card bg-info text-white">
                    <div class="d-flex justify-content-between">
                      <h3 class="font-weight-normal">Unattended:</h3>
                      <i class="material-icons options-icon text-white">more_vert</i>
                    </div>
                    <div class="mdc-layout-grid__inner align-items-center">
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-4-desktop mdc-layout-grid__cell--span-3-tablet mdc-layout-grid__cell--span-2-phone">
                        <div>
                          ...
                          <h1 class="font-weight-normal mt-3 mb-0"><?php echo $unattended?></h1>
                        </div>
                      </div>
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-8-desktop mdc-layout-grid__cell--span-5-tablet mdc-layout-grid__cell--span-2-phone">
